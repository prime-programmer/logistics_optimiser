...
def render_sidebar():
    with st.sidebar:
        ...
        st.text_input("OpenRouteService API Key", type="password", key="ors_key", 
                      help="Free at openrouteservice.org — leave blank for straight-line distances")
        ...
        # Save to state for the optimiser to access
